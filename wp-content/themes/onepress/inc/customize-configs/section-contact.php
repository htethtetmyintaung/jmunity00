...
// hr
$wp_customize->add_setting( 'onepress_contact_scut_hr', array( 'sanitize_callback' => 'onepress_sanitize_text' ) );
$wp_customize->add_control( new OnePress_Misc_Control( $wp_customize, 'onepress_contact_scut_hr',
	array(
		'section'     => 'onepress_contact_content',
		'type'        => 'hr'
	)
...
// hr
$wp_customize->add_setting( 'onepress_contact_map_hr', array( 'sanitize_callback' => 'onepress_sanitize_text' ) );
$wp_customize->add_control( new OnePress_Misc_Control( $wp_customize, 'onepress_contact_map_hr',
	array(
		'section'     => 'onepress_contact_content',
		'type'        => 'hr'
	)
